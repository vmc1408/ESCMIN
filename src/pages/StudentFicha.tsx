      ...
      <>
        <div className="my-[1mm] space-y-[4mm] flex-1 flex flex-col justify-center text-center">
          <div className="flex items-center justify-center gap-6">
             ...
             <h1 className="text-3xl font-extrabold italic text-black tracking-[0.16em] uppercase font-serif">
                CERTIFICADO DE PARTICIPAÇÃO
             </h1>
             <div className="h-[2px] w-14 bg-amber-400" />
          </div>

          <p className="text-base max-w-4xl mx-auto leading-relaxed font-sans text-slate-800 px-6 text-center">
          ...
          <p className="text-sm max-w-4xl mx-auto leading-relaxed font-sans text-slate-700 px-6 text-center">
    ...
    return (
      <>
        <div className="my-[1mm] space-y-[4mm] flex-1 flex flex-col justify-center text-center">
          ...
          <p className="text-sm max-w-4xl mx-auto leading-relaxed font-sans text-slate-600 px-6 text-center italic">
...
export function StudentFicha() {
  ...
  const filteredStudentsList = useMemo(() => {
    ...
    const filtered = students.filter(s => {
      ...
      if (clsName && matchesSearchText(clsName, term)) return true;

      const status = s.status || 'Ativo';
      if (matchesSearchText(status, term)) return true;
    ...
    return [...filtered].sort((a, b) => {
      const scoreA = calculateStudentSearchRank(a, term);
      const scoreB = calculateStudentSearchRank(b, term);
