...
const renderCertificateInnerContent = (
  ...
  if (type === 'participação') {
    return (
      <>
        <div className="my-[2mm] space-y-[6mm] flex-1 flex flex-col justify-center items-center text-center">
          <div className="flex items-center justify-center gap-6">
             <div className="h-[2px] w-20 bg-black/80" />
             <h1 className="text-4xl font-extrabold text-black tracking-[0.2em] uppercase font-display">
                CERTIFICADO DE PARTICIPAÇÃO
             </h1>
             <div className="h-[2px] w-20 bg-black/80" />
          </div>

          <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-8 text-center">
             A diretoria e coordenação da <strong className="text-black font-extrabold font-serif italic">{institutionName}</strong> confere o presente título acadêmico e formativo a:
          </p>

          <div className="py-2.5 w-full flex justify-center">
             <h2 className="text-5xl font-black uppercase tracking-widest text-slate-950 font-serif inline-block px-14 py-2 bg-slate-500/5 border-y-2 border-slate-950/10 text-center">
                {studentName}
             </h2>
          </div>

          <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-12 text-center">
             por ter participado ativamente das sessões seminaristas, colóquios, palestras e atividades práticas integradas no programa pastoral de estudos de <strong className="text-black font-extrabold italic">{courseName}</strong>.
          </p>

          <p className="text-sm max-w-4xl mx-auto leading-relaxed font-serif text-slate-600 px-8 pt-1 text-center italic">
             Comprovando digna dedicação intelectual e acadêmica compatível com as diretrizes da Diocese.
          </p>

          <p className="text-sm text-slate-900 font-bold uppercase tracking-[0.25em] mt-8 font-sans max-w-md mx-auto border-t-2 border-slate-950/20 pt-2.5 text-center">
        ...
        <div className="flex items-end justify-between px-16 mb-2 font-sans mt-6 w-full">
           <div className="flex flex-col items-center gap-1.5">
              ...
              <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Secretário Acadêmico</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-56 border-b-2 border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Coordenador do Curso</p>
           </div>
        </div>
      </>
    );
  ...
  if (type === 'honra') {
    return (
      <>
        <div className="my-[2mm] space-y-[6mm] flex-1 flex flex-col justify-center items-center text-center">
          <div className="flex items-center justify-center gap-6">
             <div className="h-[2px] w-20 bg-black/70" />
             <h1 className="text-5xl font-black text-black tracking-[0.25em] uppercase font-display">
                DIPLOMA ACADÊMICO
             </h1>
             <div className="h-[2px] w-20 bg-black/70" />
          </div>
          ...
          <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-8 text-center">
             O Conselho de Formadores e Orientadores do Seminário Maior da <strong className="text-black font-extrabold font-serif italic">{institutionName}</strong>, no cumprimento de suas atribuições ministeriais e teológicas, concede o diploma de mérito ao estudante:
          </p>
          ...
          <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-12 text-center">
             por haver concluído brilhantemente os estudos sagrados teológicos do curso de <strong className="text-black font-extrabold italic">{courseName}</strong>, demonstrando elevada idoneidade pastoral, dedicação canônica, inteligência crítica e vida espiritual exemplar.
          </p>
        ...
        <div className="flex items-end justify-between px-16 mb-2 font-sans mt-6 w-full">
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-56 border-b-2 border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Reitor do Seminário</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-56 border-b-2 border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Secretário(a) Acadêmico(a)</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-56 border-b-2 border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Bispo Diocesano</p>
           </div>
        </div>
      </>
    );
  ...
  return (
    <>
      <div className="my-[2mm] space-y-[6mm] flex-1 flex flex-col justify-center items-center text-center font-serif text-slate-900">
        <div className="flex items-center justify-center gap-6">
           <div className="h-[2px] w-20 bg-black/70" />
           <h1 className="text-4xl font-extrabold text-black tracking-[0.2em] uppercase font-display">
        ...
        <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-8 text-center">
           A <strong className="text-black font-extrabold font-serif italic">{institutionName}</strong> certifica que o(a) estudante:
        </p>
        ...
        <p className="text-lg max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-12 text-center">
           concluiu com êxito o Curso de <strong className="text-black font-extrabold italic">{courseName}</strong>, tendo cumprido satisfatoriamente todas as exigências acadêmicas e formativas previstas no programa de estudos.
        </p>

        <p className="text-sm max-w-4xl mx-auto leading-relaxed font-serif text-slate-600 px-8 text-center">
      ...
      <div className="flex items-end justify-between px-16 mb-2 font-sans mt-6 w-full">
         <div className="flex flex-col items-center gap-1.5">
            <div className="w-56 border-b-2 border-black/80" />
            <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Diretor Acadêmico</p>
         </div>
         <div className="flex flex-col items-center gap-1.5">
            <div className="w-56 border-b-2 border-black/80" />
            <p className="text-xs font-bold text-slate-700 uppercase tracking-widest text-center">Secretário Acadêmico</p>
