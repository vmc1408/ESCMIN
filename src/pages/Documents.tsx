    ...
    return (
      <>
        ...
        <div className="flex items-end justify-between px-12 mb-1 font-sans mt-4 w-full">
           ...
           <div className="flex flex-col items-center gap-1">
              <div className="w-44 border-b border-black/80" />
              <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest text-center">Coordenador do Curso</p>
           </div>
        </div>
      </>
    );
    ...
    return (
      <>
        ...
        <div className="flex items-end justify-between px-12 mb-1 font-sans mt-4 w-full">
           <div className="flex flex-col items-center gap-1">
              <div className="w-44 border-b border-black/80" />
              <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest text-center">Reitor do Seminário</p>
           </div>
           <div className="flex flex-col items-center gap-1">
              <div className="w-44 border-b border-black/80" />
