...
const renderCertificateInnerContent = (
      ...
      <>
        <div className="my-[1mm] space-y-[4mm] flex-1 flex flex-col justify-center items-center text-center">
          <div className="flex items-center justify-center gap-6">
             <div className="h-[2px] w-14 bg-black/80" />
             <h1 className="text-3xl font-bold text-black tracking-[0.18em] uppercase font-display">
                CERTIFICADO DE PARTICIPAÇÃO
             </h1>
             <div className="h-[2px] w-14 bg-black/80" />
          </div>

          <p className="text-base max-w-4xl mx-auto leading-relaxed font-serif text-slate-800 px-6 text-center">
          ...
          <div className="py-1.5 w-full flex justify-center">
             <h2 className="text-3xl font-bold uppercase tracking-widest text-slate-950 font-serif inline-block px-12 bg-slate-50/10 text-center">
                {studentName}
             </h2>
          </div>
          ...
          <p className="text-sm max-w-4xl mx-auto leading-relaxed font-serif text-slate-600 px-6 pt-0.5 text-center italic">
             Comprovando digna dedicação intelectual e acadêmica compatível com as diretrizes da Diocese.
          </p>

          <p className="text-xs text-slate-900 font-bold uppercase tracking-[0.22em] mt-3 font-sans max-w-md mx-auto border-t border-slate-200 pt-2 text-center">
             {institutionLocation}, {formatLongDate(issuanceDate)}
          </p>
        </div>

        <div className="flex items-end justify-between px-12 mb-1 font-sans mt-3 w-full">
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-48 border-b border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Secretário Acadêmico</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-48 border-b border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Coordenador do Curso</p>
           </div>
        </div>
      </>
    );
  ...
  if (type === 'honra') {
    return (
      <>
        <div className="my-[1mm] space-y-[4mm] flex-1 flex flex-col justify-center items-center text-center">
          <div className="flex items-center justify-center gap-6">
             <div className="h-[2px] w-14 bg-black/60" />
             <h1 className="text-3xl font-bold text-black tracking-[0.2em] uppercase font-display">
                DIPLOMA ACADÊMICO
             </h1>
             <div className="h-[2px] w-14 bg-black/60" />
          </div>
          ...
          <p className="text-xs text-slate-600 font-bold uppercase tracking-[0.22em] mt-3 font-sans max-w-md mx-auto text-center border-t border-slate-100 pt-1.5">
             {institutionLocation}, {formatLongDate(issuanceDate)}
          </p>
        </div>
        ...
        <div className="flex items-end justify-between px-12 mb-1 font-sans mt-3 w-full">
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-48 border-b border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Reitor do Seminário</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-48 border-b border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Secretário(a) Acadêmico(a)</p>
           </div>
           <div className="flex flex-col items-center gap-1.5">
              <div className="w-48 border-b border-black/80" />
              <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Bispo Diocesano</p>
           </div>
        </div>
      </>
    );
  ...
  return (
    <>
      <div className="my-[1mm] space-y-[4mm] flex-1 flex flex-col justify-center items-center text-center font-serif text-slate-900">
        <div className="flex items-center justify-center gap-6">
           <div className="h-[2px] w-14 bg-black/70" />
           <h1 className="text-3xl font-bold text-black tracking-[0.18em] uppercase font-display">
        ...
        <p className="text-sm max-w-4xl mx-auto leading-relaxed font-serif text-slate-600 px-6 text-center">
           Conferimos o presente Certificado de Conclusão para que produza os efeitos educacionais e institucionais cabíveis.
        </p>

        <p className="text-xs text-slate-900 font-bold uppercase tracking-[0.22em] mt-3 font-sans max-w-md mx-auto border-t border-slate-100 pt-2 text-center">
           {institutionLocation}, {formatLongDate(issuanceDate)}
        </p>
      </div>

      <div className="flex items-end justify-between px-12 mb-1.5 font-sans mt-3 w-full">
         <div className="flex flex-col items-center gap-1.5">
            <div className="w-48 border-b border-black/80" />
            <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Diretor Acadêmico</p>
         </div>
         <div className="flex flex-col items-center gap-1.5">
            <div className="w-48 border-b border-black/80" />
            <p className="text-xs font-bold text-slate-700 uppercase tracking-wider text-center">Secretário Acadêmico</p>
...
export function Documents() {
  ...
  const fetchData = React.useCallback(async () => {
    try {
      ...
      const normalizedSubjects = (subs || []).map((s: any) => normalizeSubject(s));
      ...
      setSubjects(normalizedSubjects.filter((sub: any) => sub.status === 'Ativo' || !sub.status));
    ...
    <div className="max-w-7xl mx-auto space-y-6 px-4 py-3 pb-20">
      ...
      {viewingCertificate && typeof document !== 'undefined' && createPortal(
        <div 
          ...
          className="hidden print:flex absolute left-0 top-0 bg-white text-black font-serif justify-between text-center select-none pointer-events-none z-[99999] overflow-hidden flex-col box-border w-[297mm] h-[210mm] max-w-[297mm] max-h-[210mm] p-[10mm]"
        >
          <div className={getCertificateBorderClassName(viewingCertificate.type)}>
             {renderCertificateDecorations(viewingCertificate.type)}
