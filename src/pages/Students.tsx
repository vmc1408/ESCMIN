          ...
          <div className="border-t border-black/10 pt-3 flex justify-between items-end text-[7.2pt] font-medium text-slate-500 uppercase tracking-tight">
            <div className="flex-1 space-y-0.5">
              ...
              <p className="flex items-center gap-2">
                ...
                {inst?.phone && (inst?.whatsapp || inst?.email) && <span className="opacity-30 mx-1">•</span>}
                {inst?.whatsapp && (
                  <span className="flex items-center gap-1 text-green-700 font-bold">
                    {inst.whatsapp}
                    <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" className="mt-0.5">
                ...
                {inst?.whatsapp && inst?.email && <span className="opacity-30 mx-1">•</span>}
