              ...
              <p className="flex items-center gap-3">
                {inst?.phone && (
                  <span className="flex items-center gap-1.5">
                    <span className="opacity-70 text-[6.5pt]">Tel:</span> {inst.phone}
                    {inst?.whatsapp === inst?.phone && (
                      <span className="text-[6.5pt] font-black text-green-700 ml-0.5">(WhatsApp)</span>
                    )}
                  </span>
                )}
                ...
                {inst?.whatsapp && inst?.whatsapp !== inst?.phone && (
                  <span className="flex items-center gap-1.5 text-green-700 font-bold">
                    <span className="opacity-70 text-[6.5pt] text-slate-500 font-medium">WhatsApp:</span> {inst.whatsapp}
                  </span>
                )}
                {inst?.whatsapp && inst?.email && (
                  <span className="text-slate-300 font-light mx-1">|</span>
                )}
                {inst?.email && (
                  <span className="flex items-center gap-1.5">
                    <span className="opacity-70 text-[6.5pt]">E-mail:</span>
                    <span className="lowercase underline opacity-80">{inst.email}</span>
                  </span>
                )}
              </p>
            </div>
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="col-span-4 space-y-1">
                        ...
                        <input 
                          ...
                          onKeyDown={handleKeyDown}
                          className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-normal focus:ring-2 focus:ring-blue-500/20 disabled:opacity-60"
