              ...
              <p className="flex items-center gap-4">
                {inst?.phone && (
                  <span className="flex items-center gap-1">
                    <span className="opacity-70">Tel:</span> {inst.phone}
                  </span>
                )}
                {inst?.whatsapp && (
                ...
                {inst?.email && <span className="lowercase underline">{inst.email}</span>}
                {inst?.cnpj && <span className="ml-auto opacity-70">CNPJ: {inst.cnpj}</span>}
              </p>
            </div>
