            ...
            <div className="flex-1 space-y-0.5">
              ...
              <p className="flex items-center gap-4">
                {inst?.phone && (
                  <span className="flex items-center gap-1.5">
                    ...
                    {inst?.whatsapp === inst?.phone && (
                      <svg viewBox="0 0 24 24" width="12" height="12" fill="#25D366" className="shrink-0 ml-0.5">
                ...
                {(inst?.phone && (inst?.whatsapp || inst?.email)) && (
                  <span className="text-slate-900 font-black px-1 scale-y-125 opacity-30">|</span>
                )}
