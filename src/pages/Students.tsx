            ...
            <div className="flex-1 space-y-0.5">
              ...
              <p className="flex items-center gap-2">
                {inst?.phone && (
                  <span className="flex items-center gap-1">
                    ...
                    {inst?.whatsapp === inst?.phone && (
                      <svg viewBox="0 0 24 24" width="12" height="12" fill="#25D366" className="ml-0.5">
                ...
                {(inst?.phone && (inst?.whatsapp || inst?.email)) && (
                  <span className="text-slate-400 font-black mx-1 opacity-80">|</span>
                )}
                ...
                {inst?.email && <span className="lowercase underline opacity-80">{inst.email}</span>}
              </p>
            </div>
