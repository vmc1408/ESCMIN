        ...
        <div className="w-full">
          ...
          <div className="border-t border-black/10 pt-3 flex justify-between items-end text-[7.2pt] font-medium text-slate-500 uppercase tracking-tight">
            <div className="flex-1 space-y-0.5">
              ...
              <p className="flex items-center gap-1.5 text-[6.5pt] font-bold text-slate-800 uppercase tracking-tight">
                {inst?.phone && (
                  <span className="flex items-center gap-1 whitespace-nowrap">
                    <span className="opacity-70">TEL:</span>
                    <span className="text-slate-800">{inst.phone}</span>
                ...
                {inst?.whatsapp && inst?.whatsapp !== inst?.phone && (
                  <span className="flex items-center gap-1 whitespace-nowrap">
                    <svg viewBox="0 0 24 24" width="9" height="9" fill="#25D366" className="shrink-0">
                      ...
                      <span className="text-slate-800">{inst.whatsapp}</span>
                    </span>
                  )}
                ...
                {inst?.email && (
                  <span className="flex items-center gap-1 whitespace-nowrap">
                    ...
                    <span className="lowercase text-slate-800">{inst.email}</span>
                  </span>
                )}
              </p>
              {inst?.footer_text && (
                <p className="mt-1.5 pt-1.5 border-t border-slate-100 text-[6.5pt] font-black text-slate-400 uppercase tracking-widest">{inst.footer_text}</p>
              )}
            </div>
