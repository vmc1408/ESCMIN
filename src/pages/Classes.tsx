...
export function Classes() {
  ...
  return (
    <div className="h-[calc(100vh-6rem)] relative flex flex-col lg:flex-row gap-4 w-full p-4 overflow-hidden bg-slate-100/40">
      ...
      {selectedClass && (
        <div id="printable-class-record" className="hidden print:flex flex-col justify-between text-black bg-white overflow-hidden font-sans leading-tight relative w-full h-[260mm] max-h-[260mm] mx-auto p-0">
