    ...
    <div className="h-[calc(100vh-6rem)] relative flex flex-col lg:flex-row gap-4 w-full p-4 overflow-hidden bg-slate-100/40">
      ...
      {selectedClass && (
        <div id="printable-class-record" className="hidden print:block text-black bg-white overflow-visible font-sans leading-tight relative w-full h-[285mm] mx-auto">
          <div className="w-full max-w-[210mm] mx-auto bg-white p-8 flex flex-col justify-between h-full min-h-[285mm]">
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 gap-3.5">
                  ...
                  <div className="border-b border-black/10 pb-2">
                    ...
                    <div className="text-[10pt] leading-relaxed text-justify whitespace-pre-line min-h-[30px]">
                      {(() => {
            ...
            {/* Institutional Footer - Positioned at the very bottom of the page */}
            <div className="mt-auto border-t-2 border-black pt-3 flex justify-between items-start text-[8.5pt] font-bold text-black uppercase tracking-tight mb-2 shrink-0">
              <div className="flex-1 space-y-1">
                ...
                {(inst?.phone || inst?.email) && (
                  <div className="flex items-center gap-4 leading-none font-bold text-[9pt] pt-0.5">
                    {inst?.phone && (
